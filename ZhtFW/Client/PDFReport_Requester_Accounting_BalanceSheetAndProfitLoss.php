   ...
   namespace
      ...
      $varParameterData = array(
         ...
         'Data' => array(
            'Report' => array(
               'Mode' => 'PDF',
               'Type' => 'Accounting_BalanceSheetAndProfitLoss'
               ),
            'Parameter' => array(
               'StartDateTime' => (isset($_GET['StartDateTime'])?$_GET['StartDateTime']:'2017-01-01 00:00:00'),
               'FinishDateTime' => (isset($_GET['FinishDateTime'])?$_GET['FinishDateTime']:'2017-12-31 23:59:59')
               )
            )
         );
