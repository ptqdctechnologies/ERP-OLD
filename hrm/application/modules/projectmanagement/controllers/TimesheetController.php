...
//        $tgl2 = rawurldecode($this->getRequest()->getParam("tgl2"));
        ...
        SELECT
            *,
            COALESCE(((z.hour / z.totalhour1) * 100),0) as persen,
        ...
        if ($hasil)
        {
            ...
            $this->view->tgl1 = date("d M Y",strtotime($tgl1));
            $this->view->tgl2 = date("d M Y",strtotime($tgl2));
    ...
    public function detailtimesheet4Action()
	{
        ...
        $fetch = $this->timesheet->fetchAll($where,array("uid ASC"),50,$offset);
