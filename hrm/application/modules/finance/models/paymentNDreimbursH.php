...
class Finance_Models_paymentNDreimbursH extends Zend_Db_Table_Abstract
{
    ...
    public function viewpaiddebitnote($offset=0,$limit=0,$dir='DESC',$sort='trano',$search)
    {
        ...
        $query = "SELECT SQL_CALC_FOUND_ROWS PDN.trano,PDN.tgl,PDN.dn_no,PDN.prj_kode,PDN.sit_kode,rem_no FROM (finance_payment_reimbursement_nd PDN LEFT JOIN finance_nd_reimbursement DN ON PDN.dn_no = DN.trano)
