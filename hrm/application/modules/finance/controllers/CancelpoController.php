...
//        $poworkflow = $this->workflowtrans->fetchRow ("item_id = '$potrano'");
    ...
    public function docancelpoAction ()
    {
        ...
        if (!$isRpi)
        {
            ...
            $poh = $this->poheader->fetchAll("trano = '$trano'")->toArray();

            $log['po-header-before'] = $poh;
            ...
            $log2['po-header-after'] = $this->poheader->fetchAll("trano = '$trano'")->toArray();
            ...
            $arrayLog = array (
                  ...
                  "prj_kode" => $poh['prj_kode'],
                  "sit_kode" => $poh['sit_kode'],
                  "action" => "CANCEL",
                  "data_before" => $jsonLog,
                  "data_after" => $jsonLog2,
                  "ip" => $_SERVER["REMOTE_ADDR"],
