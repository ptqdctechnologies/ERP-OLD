...
Ext.ux.Printer.BaseRenderer = Ext.extend(Object, {
     ...
     */
//    print: function(component) {
    //Modif utuk bisa menerima lebih dari 1 parameter
    //params : array()
    //component : object dari grid yg akan di print
    //printTitle : judul dari dokumen yg akan di print
    print: function(params) {
...
//        win.document.write(this.generateHTML(component));
        win.document.write(this.generateHTML(params));
...
//    getTitle: function(component) {
     ...
     */
    stylesheetPath: '/js/layout/ux/printer/printer.css'
});
...
Ext.ux.Printer.BaseRenderer.prototype.stylesheetPath = '/js/layout/ux/printer/printer.css';
        ...
        Ext.apply(this, {
            ...
            bodyTpl: new Ext.XTemplate(
...

                {
                    ...
                    //Template untuk summary (Paling bawah per group)
            ...
            getColumns: function(grid) {
                if (this.columns == null) {
                    ...
                    Ext.each(grid.getColumnModel().config, function(col, index) {
                        ...
                        if (col.id == 'numberer' || col.index == 'actions')
                            return true;
                        if (col.hidden != true) {
                            columns.push(
                                {
