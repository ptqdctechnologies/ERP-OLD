...
class Procurement_Model_PaymentReimbursH extends Zend_Db_Table_Abstract
{
...
//            $where = "WHERE $search";
//
//        $query = "SELECT SQL_CALC_FOUND_ROWS trano,tgl,rem_no,prj_kode,sit_kode FROM finance_payment_reimbursement $where
