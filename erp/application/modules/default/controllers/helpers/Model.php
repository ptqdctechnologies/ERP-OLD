...
class Zend_Controller_Action_Helper_Model extends Zend_Controller_Action_Helper_Abstract
{
    ...
    function getModelClass($modelName='')
    {
    	...
    	switch($modelName)
    	{
    		...
    		break;
            case 'AFES':
    		$newClass = new ProjectManagement_Models_AFESaving();
    		break;
            case 'RPI':
    ...
    function getModelNewClass($modelName='')
    {
    	if ($modelName == '')
    		return false;
    	...
    	switch($modelName)
    	{
    		...
    		break;
            case 'ARF':
                $newClass = new Default_Models_AdvanceRequestFormH();
                break;
            case 'ARFP':
                $newClass = new Default_Models_ProcurementArfh();
                break;
            case 'ARFO':
                $newClass = new Default_Models_AdvanceRequestFormH('O');
                break;
            case 'ASF':
                $newClass = new Default_Models_AdvanceSettlementFormH();
                break;
            ...
            case 'APRACO':
                ...
                break;
            case 'BRF':
                $newClass = new Procurement_Models_BusinessTripHeader();
                break;
            case 'BRFP':
                $newClass = new Procurement_Models_BusinessTripPayment();
                break;
