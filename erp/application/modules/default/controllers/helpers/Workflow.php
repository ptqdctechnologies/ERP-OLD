...
Zend_Controller_Action_Helper_Abstract {
    ...
    function setWorkflowTrans($itemID = '', $workflowType = '', $paramArray = '', $approve = '', $items = '', $prjKode = '', $generic = false, $revisi = false, $comment = '') {
        ...
        if ($myClass) {
            ...
            if ($approve != $this->const['DOCUMENT_SUBMIT']) {
                ...
                if($workflowType == 'AFE' && !$result){
                    $myClass = $this->model->getModelClass("AFES");
                    $result = $myClass->fetchRow($this->db->quoteInto($primaryKey . ' = ?', $id));
                }
                if ($items != '') {
