...
//                        $account = $ldapdir->getAccount($username);
    ...
    {
        $sql = "SELECT a.uid,a.master_login,a.Name,a.id_privilege,a.id AS id_user,b.id AS id_role FROM master_login a LEFT JOIN master_role b ON (a.id = b.id_user) WHERE a.uid='" . $username . "' AND a.Pass=MD5('" . $password . "')";
