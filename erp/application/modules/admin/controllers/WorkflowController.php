        ...
        if ($isExist) {
            ...
            foreach ($cekTrans as $key => $val) {
                ...
                if ($cekWorkNow) {
                    ...
                    if ($fetch2['approve'] != $this->const['DOCUMENT_FINAL']){
                        ...
                        $this->db->query("UPDATE workflow_trans SET uid_next = '$newUidNext', workflow_id = $newWorkflow_id, workflow_structure_id = $newWorkflow_structure_id where uid = '$uid' AND workflow_item_id = $workflow_item_id AND workflow_trans_id = $workflow_trans_id");
                    }
                }
            }
            echo "{success: true}";
