...
$data['posts'] = $db->query('SELECT a.trano,a.total AS total_po, b.total AS total_rpi,COALESCE((a.qty - b.qty),0) AS balance,COALESCE((a.total - b.total),0) AS balance_total, b.tgl_rpi AS tgl_last_rpi, a.val_kode,a.tgl_po,a.prj_kode,a.sit_kode,a.prj_nama,a.sit_nama FROM pod a RIGHT JOIN rpid b ON a.trano = b.po_no WHERE COALESCE((a.qty - b.qty),0) > 0 ORDER BY a.tgl_po DESC,b.tgl_rpi DESC');
