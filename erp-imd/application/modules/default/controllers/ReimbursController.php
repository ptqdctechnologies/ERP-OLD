...
class ReimbursController extends Zend_Controller_Action
{
    ...
    public function listAction()
    {
        ...
        $project = new Default_Models_MasterSite();
            ...
            $sql = "SELECT SQL_CALC_FOUND_ROWS *
                    FROM procurement_reimbursementh
                    ORDER BY
                        trano ASC
                    LIMIT 0,100
                    ";
    ...
    public function listbyparamsAction()
    {
        ...
        $sql = 'SELECT SQL_CALC_FOUND_ROWS trano,prj_kode,prj_nama,sit_kode,sit_nama FROM procurement_reimbursementh WHERE ' . $columnName . ' LIKE \'%' . $columnValue . '%\' ORDER BY ' . $sort . ' '  . $dir . ' LIMIT ' . $offset . ',' . $limit;
