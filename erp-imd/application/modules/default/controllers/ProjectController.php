...
class ProjectController extends Zend_Controller_Action
{
    ...
    public function listAction()
    {
        ...
        {
            $where='';
            if($category !=null || $category !=''){$where=" Prj_Nama LIKE '%$category%'";}
            
            $return['posts'] = $project->getProjectOverhead($showAll,$where,$sort,$dir);
        	$return['count'] = count($return['posts']);
        }
...
//        if (!$showAll)
    ...
    public function listbyparamsprojectAction()
    {
        $this->_helper->viewRenderer->setNoRender();
        $request = $this->getRequest();
