...
//        $return['data'] = $arfs;
    ...
    public function genStockCardAction() {
        ...
        $nama_gdg = $this->_getParam("gdg_name");
        ...
        $query = "select SQL_CALC_FOUND_ROWS * from master_gudang $where;";
        $gdg = $this->db->query($query);
        $gdg = $gdg->fetchAll();


//        $this->view->flagSaldo = $flagSaldo;
//        $this->view->temp = $temp;
        $this->view->gudang = $gdg;
        $this->view->nama_gdg = $nama_gdg;
//        $this->view->result = $data['data'];
        $this->view->result = $temp;
