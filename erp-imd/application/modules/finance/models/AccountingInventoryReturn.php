...
class Finance_Models_AccountingInventoryReturn extends Zend_Db_Table_Abstract
{
    protected $_name = 'accounting_inventory_return';

    protected $db;
    protected $const;
    protected $jurnalinventory;

//    private $debitInventoryIn = '1-3001';
//    private $creditInventoryIn = '5-1070';
...
//        }
    ...
    private function getCoaJurnalInventory($gdg_from,$gdg_to){
        ...
        $coa = $this->jurnalinventory->fetchRow("gdg_kode_from = '$gdg_from' AND gdg_kode_to ='$gdg_to'")->toArray();
        return $coa;
