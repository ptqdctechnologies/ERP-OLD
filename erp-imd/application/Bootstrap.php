...
//                $layout->disableLayout();
    ...
    protected function _initConnection()
    {
		...
		$bypass = array(
						...
						array("module" => "mc","controller" => "version", "action" => "index") //mobile client
						);
...
//        Zend_Db_Table_Abstract::setDefaultMetadataCache($cache);
    ...
    {
        $configs   = $this->getOption('mail');
        $params = array(
            "hostname" => $configs['params']['smtpserver'],
            "username" => $configs['params']['smtpuser'],
            "password" => $configs['params']['smtppassword']
        );
        Zend_Registry::set('smtp', $params);
    }
}
?>