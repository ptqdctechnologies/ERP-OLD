...
Ext.ux.GroupSummary2 = Ext.extend(Ext.util.Observable, {
    ...
    summary_colors: [ "#BFAFD9", "#9ACDE6", "#EAEAEA"],
    ...
    get_summary_bgcolor_text : function(g) {
        return !this.show_summary_colors ? "" :
            "background-color:" + this.summary_colors[g.group_level] + ";"
    },
    renderSummary : function(o, cs, g){
        ...
        var group_summary_desc = "summary for this " + g.text + ": " + g.key;
        ...
        summary_color_text = this.get_summary_bgcolor_text(g);
